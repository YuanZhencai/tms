...
import static com.wcs.tms.message.MessageConveyorFactory.messageConveyerFactory;
 ...
 * @author Chris Guan
 */
public class AccessExceptionKeyMessage implements AccessExceptionMessage, Serializable
{
    ...
    */
   public <E extends Enum<?>> AccessExceptionKeyMessage(E key, Object... args)
   {
      this.messageKey = key;
