...
public class ServiceException extends RuntimeException
{
   ...
   private AccessExceptionMessage message;
   ...
   {
      super(e);
      this.message = new AccessExceptionStringMessage(e.getLocalizedMessage());
   }
   ...
   {
      this.message = new AccessExceptionKeyMessage(key, args);
   }

   public ServiceException(String rawMessage){
    ...
    * @param args Optional arguments to insert into the message
    */
   public <E extends Enum<?>> ServiceException(E key, Exception e, Object... args)
   {
      super(e);
      this.message = new AccessExceptionKeyMessage(key, args);
   }
   ...
   {
      super();
      this.message = new AccessExceptionListMessage(errors);
   }
